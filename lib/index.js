...
const subscribe = (component, has, handlers) => {
	if (has === '*') {
...
const connect = (ComponentToConnect, connectProps) => {
	let ready = false;
	let {has, handlers, shouldHave: shouldHaveString} = connectProps;
