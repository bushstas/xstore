...
function addReducer(actions, name) {
	if (actions instanceof Object && !ACTIONS[name]) {
		ACTIONS[name] = actions;
		STORAGES[name] = {};
		if (actions.init instanceof Function) {
			STORAGES[name] = actions.init() || {};
		}
		distributeChanges(name);
	}
}
